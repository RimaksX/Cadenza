...
//! a different mood deserves to be judged again rather than inheriting an old
//! answer. Aggregating across sessions is then a query, which is the shape that
//! lets the weight of an old opinion be reconsidered without a migration.
//!
