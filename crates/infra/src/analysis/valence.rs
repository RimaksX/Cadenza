...
//! ones. It is a *heuristic* and is used as one — a weight among several in
//! radio's ranking, never a label shown to anybody as fact. Doing better would
//! take a trained model, which is forbidden here; doing worse would be to leave
//! the column empty and have radio treat every track alike.
