...
Свежесть считается по собственным выборам радио. На момент M13 историю
прослушиваний никто не писал; M14 её пишет, и источник ещё предстоит расширить —
формулу при этом не трогая (`MASTER_ISSUES` 49).
