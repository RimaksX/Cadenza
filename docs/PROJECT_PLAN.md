...
- ~~масштабирование интерфейса~~ — сделано: четыре ступени в настройках, у
  профиля, применяются при следующем запуске (`MASTER_ISSUES` 64);
- **drag-and-drop треков внутри приложения** — не существует вовсе: перетаскивать
  в окне можно только само окно, ручку эквалайзера и головку воспроизведения.
  Ждёт решения про Slint 1.17 (`MASTER_ISSUES` 58).
